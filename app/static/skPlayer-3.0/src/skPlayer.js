...
/*    constructor(option){
    ...
    template(){
        //源码有修改
        let html = `
            <audio class="skPlayer-source" src="" preload="auto"></audio> <!--#有改动-->
            <div class="skPlayer-picture">
                <img class="skPlayer-cover" src="" alt="">
            ...
            <div class="skPlayer-control">
                <p class="skPlayer-name"></p><!--#有改动-->
                <p class="skPlayer-author"></p><!--#有改动-->
        ...
        for(let index in this.music){
            html += `
                <li data-index="${index}">
                    ...
                    <span class="skPlayer-list-name" title=""></span><!--#有改动-->
                    <span class="skPlayer-list-author" title=""></span><!--#有改动-->
                </li>
            `;
        }
        html += `
